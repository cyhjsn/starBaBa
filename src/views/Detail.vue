  ...
  <div class="detail">
    ...
    <van-goods-action>
      ...
      <van-goods-action-icon
        ...
        :color="likeStatus ? '#106e33' : '#666'"
        @click="likeAndNotLike"
      />
      <van-goods-action-button type="warning" text="加入购物袋" @click="addShopbag" color="#20944b" />
      <van-goods-action-button type="danger" text="立即购买" @click="buyNow" color="#106e33" />
    </van-goods-action>
  </div>
</template>
